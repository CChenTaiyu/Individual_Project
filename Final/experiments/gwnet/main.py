...
# Uncomment the below codes for different methods
# from src.models.gwnet_original import GWNET
# from src.models.gwnet_meta_matrix import GWNET
# from src.models.gwnet_meta_tcn import GWNET
from src.models.gwnet_meta_gat import GWNET
...
def main():
    ...
    # This is for meta GAT to find nearest 3 neighbors
    dst_indices = np.argsort(adj_mx, axis=1)[:, -4:]
    ...
    adp_adj_meta = np.load('data/sd/2019/meta.npy')
